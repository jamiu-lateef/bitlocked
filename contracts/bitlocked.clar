;; Title: BitLocked Protocol
;;
;; Summary:
;; Transform idle Bitcoin into productive capital through trustless collateralization.
;; Access liquidity while retaining full exposure to BTC price appreciation via
;; Bitcoin-anchored smart contracts on Stacks Layer 2.
;;
;; Description:
;; BitLocked bridges Bitcoin's store of value with DeFi utility. Lock BTC as
;; collateral, mint stablecoin loans with algorithmic risk management, and
;; unlock capital without selling. Every state transition settles to Bitcoin's
;; base layer for uncompromising security.
